...
-- file). Same posture as 0001-0004: STRICT + WITHOUT ROWID, `workspace_id`-scoped rows.
--
...
-- follower, and writing its 0600 at-rest file) is the deferred enrollment subsystem's job; v0 seeds these as
-- fixtures.
