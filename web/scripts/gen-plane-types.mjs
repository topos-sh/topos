#!/usr/bin/env node
/**
 * gen-plane-types.mjs — generate the TypeScript types for the SESSION WIRE this app SERVES.
 *
...
const PUBLIC_ROUTES = [
  ...
  { method: "delete", path: "/v1/workspaces/{ws}/profile/channels/{ch}" },
  { method: "put", path: "/v1/workspaces/{ws}/profile/channels/{ch}" },
  { method: "delete", path: "/v1/workspaces/{ws}/profile/skills/{skill}" },
  { method: "put", path: "/v1/workspaces/{ws}/profile/skills/{skill}" },
