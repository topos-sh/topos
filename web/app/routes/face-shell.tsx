 ...
 * browser sees with no existence oracle. Every workspace-scoped face answers the uniform house 404
 * (members-only, indistinguishable from a mistyped path); the ONE face that renders for a
 * signed-out visitor is the workspace root in SINGLE tenancy, where it is the install's own
 * landing page rather than a workspace address. The chrome loads only for a signed-in visitor; the
 * face module itself decides member (canonical page) vs signed-in non-member (house 404).
 */
