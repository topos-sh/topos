 ...
 * (`crates/plane-store/migrations/*.sql` — the single source of truth; no vendoring; every
 * migration, in filename order), so a test database gets the REAL custody DDL the app's read-only
