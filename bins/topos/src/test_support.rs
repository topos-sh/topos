...
fn connect_session(cache_dir: PathBuf) -> impl Fn(&Session) -> ops::SessionTransports {
    move |s: &Session| ops::SessionTransports {
        plane: Box::new(
            UreqPlane::new(
                s.base_url.clone(),
            ...
            .with_fetch_cache(FetchCache::new(cache_dir.clone(), Rc::new(RealFs))),
        ),
