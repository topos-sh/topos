...
//!
//! ```toml
//! # Generated by `topos update`. Records the exact versions this project runs — commit it.
//! schema = 1
...
impl LockDoc {
    ...
    pub(crate) fn serialize(&self) -> String {
        let mut out = String::from(
            "# Generated by `topos update`. Records the exact versions this project runs — \
             commit it.\nschema = 1\n",
        );
