...
pub(crate) use add::{
    ...
    add_remote, add_remote_fetched, add_with_name, adopt_path, extend_folder_dest,
    governed_copy_suggestion, keep_as_yours, origin_dir, origin_dir_or_self, plan_bare_add,
    refuse_unflagged_mcp_dir, resolve_add_target, split_target, tracked_skill_at,
};
pub(crate) use add_mcp::{McpAdded, add_mcp};
#[cfg(test)]
pub(crate) use arm::INERT_TRIGGER;
pub(crate) use arm::{EvidenceView, MachinePorts, Scrubbed, Triggers};
pub(crate) use builtin::{
    ensure_builtin, ensure_builtin_for_project_pick, is_builtin,
    placement_dirs as builtin_placement_dirs, restore_builtin,
    scope_layout as builtin_scope_layout, skill_md as builtin_skill_md,
};
...
pub(crate) use reconcile::{
    CacheFollow, ForgeCadence, LockMode, ManifestUpdateOpts, SessionRoutedPlane, SessionTransports,
...
pub(crate) use revert::{RevertConnectors, RevertOutcome, revert};
